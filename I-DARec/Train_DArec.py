...
parser.add_argument("--S_pretrained_weights", type=str, default=r'./pretrained_weights/S_AutoRec_50.pkl')
parser.add_argument("--T_pretrained_weights", type=str, default=r'./pretrained_weights/T_AutoRec_50.pkl')
...
if __name__=="__main__":
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        if epoch % args.epochs == args.epochs - 1:
            torch.save(net.state_dict(), os.path.join(wdir, "DARec_I_%d.pkl" % (epoch+1)))
