...
parser.add_argument('--train_S', type=int, help="Whether to train the source autoencoder", default=0)
...
model = I_AutoRec(n_users=n_users, n_items=n_items, n_factors=args.n_factors)
criterion = MRMSELoss()
